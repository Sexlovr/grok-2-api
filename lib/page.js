...
// On 401 (no/expired token — e.g. the Space restarted) drop the token and show
// the login form. Do NOT location.reload(): with a stale token that loops.

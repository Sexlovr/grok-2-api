...
<div class="wrap">
  ...
  <div id="app" class="hide">
    ...
    <div class="card">
      ...
      <p class="small mut">A headed Chromium runs inside the Space, opens grok.com already logged in (cookies seeded from your account), and feeds fresh sigs automatically — no phone tab needed. Use the recovery console below <b>only</b> if grok shows a Cloudflare challenge you must click through.</p>
      <div class="row" style="margin-top:8px">
        <button class="ghost" onclick="brRestart()">Restart browser</button>
...
let SCR=null;
async function brRestart(){try{await api('/admin/browser/restart',{method:'POST'});toast('Browser restarting');loadStatus();}catch(e){toast(e.message,1);}}

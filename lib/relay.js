...
const WORKER_FRESH_MS = 60 * 1000;      // a worker seen within this window is "online".
                                        // MUST exceed the worker's 45s stream-stall
                                        // abort + slack, so a near-stalled (but alive)
                                        // worker isn't declared offline mid-job and
                                        // doesn't cause a queued 2nd job to be fast-failed.

...
export class GrokBrowser {
    ...
    async loadAccount(account) {
        ...
        // Short settle for Cloudflare; do NOT wait for full hydration — that is
        // when the <head> meta gets stripped.
        await this.page.waitForTimeout(2500);

        // Diagnostics: what did this IP land on, and did we capture the token?
        try {
            ...
            console.log('[Grok][diag] page after load:', JSON.stringify(diag), 'tokenCaptured:', !!verifyToken);
        } catch (e) {
